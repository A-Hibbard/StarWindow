...
export default function DefaultDashboardScreen() {
  ...
  return (
    <View style={styles.guestShell}>
      <View style={styles.guestSidebarWrap}>
        <AppSidebar />
        <View style={styles.sidebarBlocker} />
        <View style={styles.sidebarAuthPanel}>
          <Pressable style={styles.sidebarSignInButton} onPress={() => router.push('/login' as any)}>
            <Text style={styles.sidebarSignInText}>SIGN IN</Text>
          </Pressable>
          <Pressable style={styles.sidebarCreateButton} onPress={() => router.push('/signup' as any)}>
            <Text style={styles.sidebarCreateText}>CREATE ACCOUNT</Text>
          </Pressable>
        </View>
      </View>
...
{/*
          ...
          <Pressable style={styles.profileCard} onPress={() => router.push('/signup' as any)}>
...
function PreviewCard({
  ...
  return (
    <Pressable style={styles.previewCard} onPress={() => router.push('/signup' as any)}>
      <View style={styles.previewThumb}>
        {thumb}
        <View style={styles.cardLockOverlay}>
          <View style={styles.cardLockCircle}><Text style={styles.cardLockIcon}>🔒</Text></View>
...
const styles = StyleSheet.create({
  ...
  guestShell: { flex: 1, flexDirection: 'row', backgroundColor: Palette.bgVoid },
  guestSidebarWrap: { width: 128, position: 'relative', zIndex: 20 },
  sidebarBlocker: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: 2 },
  sidebarAuthPanel: { position: 'absolute', left: 10, right: 10, bottom: 14, zIndex: 3, gap: 8, backgroundColor: Palette.bgDeep, paddingTop: 8 },
  sidebarSignInButton: { height: 34, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Palette.borderSoft, borderRadius: Radius.md },
  sidebarSignInText: { color: Palette.textTertiary, fontSize: 9, fontWeight: '700', letterSpacing: 0.8 },
  sidebarCreateButton: { minHeight: 38, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Palette.accentMoon, borderRadius: Radius.md, paddingHorizontal: 5 },
  sidebarCreateText: { color: Palette.accentMoon, fontSize: 8, fontWeight: '700', letterSpacing: 0.5, textAlign: 'center' },
  ...
  guestBanner: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 18, padding: 18, borderWidth: 1, borderColor: Palette.accentMoon + '55', borderRadius: Radius.lg, backgroundColor: Palette.surfaceRaised },
  guestBannerCopy: { flex: 1 },
  guestBannerEyebrow: { color: Palette.accentMoon, fontSize: 9, fontWeight: '700', letterSpacing: 1.2, marginBottom: 5 },
  guestBannerTitle: { color: Palette.textPrimary, fontSize: 18, fontWeight: '700', marginBottom: 5 },
  guestBannerText: { color: Palette.textSecondary, fontSize: 12, lineHeight: 18 },
  guestBannerButton: { paddingHorizontal: 18, paddingVertical: 12, borderWidth: 1, borderColor: Palette.accentMoon, borderRadius: Radius.md },
  guestBannerButtonText: { color: Palette.accentMoon, fontSize: 9, fontWeight: '700', letterSpacing: 0.9 },
